...
public class fisherman {
    public static void main(String[] args) {
        ...
        System.out.println("##                                                ##");
        System.out.println("##                Fisherman  Simulator            ##");
        System.out.println("####################################################");
        ...
        while (true) { // maingame start here
            ...
            if (day == 1) { // only for first day
                ...
                System.out.println("I will introduce you to a menu");
                System.out.println();
            ...
            // showArray(quest); // print array quest
            System.out.println();
            ...
            if (inputWhere == 100) {
                ...
                while (chanceleft > 0) {
                    ...
                    // sea
                    System.out.println();
                    System.out.println("Let's see what can we do here ");
    ...
    public static int fishing() {
        ...
        switch (fish) {
            ...
            case 3:
                ...
                break;
            case 4:
                System.out.println("So pity, you got just an old sneaker. it doesn't count");
                break;
        }
